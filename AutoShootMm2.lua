-- =============================================================
-- MATZZHUB MM2 — COMPLETO • FINAL • LISTO PARA USAR
-- AutoBomb + AutoShoot + SilentAim + GUI + Todo
-- =============================================================
...
local function ApplyThemeToGUI()
    ...
    if BombFrame then
        ...
        local bombStroke = BombFrame:FindFirstChildOfClass("UIStroke")
        if bombStroke then
            bombStroke.Color = Theme.Accent
        end
    end
...
local function SaveConfig()
    ...
    if ShootButton then saveData.GuiPositions.Shoot = ShootButton.Parent.Position end
